    ...
    let normal = keymap!({ "Normal mode"
        ...
        "d" => { "Del"
            ...
            "k" => [select_mode, 
                    ...
                    delete_selection, 
                    normal_mode],
            "b" => [select_mode, evil_prev_word_start, delete_selection],
            "e" => [select_mode, evil_next_word_end, delete_selection],
            "w" => [select_mode, evil_next_word_start, delete_selection],
            "B" => [select_mode, evil_prev_long_word_start, delete_selection],
            "E" => [select_mode, evil_next_long_word_end, delete_selection],
            "W" => [select_mode, evil_next_long_word_start, delete_selection],

            "0" => [select_mode, goto_line_start, delete_selection],
            "$" => [select_mode, goto_line_end, delete_selection],
        },
